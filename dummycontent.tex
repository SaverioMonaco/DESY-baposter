...
\newcommand{\dummycontentsomethingelse}{
	...
	\LipsumPar{66}
	\begin{center}
		\includegraphics[width=.65\linewidth]{./imgs/cat_vertical.jpg}
		\captionof{figure}{A photo of a cute cat (I run out of ideas for things to add)}
	\end{center}
}


\newcommand{\dummycontentacknowledgements}{
	Passione has received funding from the European Union’s 2020 Research Programme under the Forza Napoli Grant Agreement No. 12345678.
}